...
<head>
    ...
    <title><?= e($title ?? 'Reviewer Panel') ?></title>
...
<body>
    <nav class="navbar navbar-expand-lg fixed-top border-bottom">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="<?= url('/reviewer/dashboard') ?>">
                <i class="bi bi-clipboard-check text-info me-2"></i>Reviewer Panel
            </a>
    ...
    <div class="d-flex">
        <aside class="sidebar border-end p-0 d-none d-lg-block">
            <nav class="nav flex-column py-2">
                ...
                <a class="nav-link <?= ($activeMenu ?? '') === 'dashboard' ? 'active' : '' ?>" href="<?= url('/reviewer/dashboard') ?>"><i class="bi bi-speedometer2"></i>Dashboard</a>
                <div class="nav-header">Content Review</div>
                <a class="nav-link <?= ($activeMenu ?? '') === 'uploads' ? 'active' : '' ?>" href="<?= url('/reviewer/uploads') ?>"><i class="bi bi-upload"></i>Pending Uploads</a>
                <div class="nav-header">Rights Management</div>
                <a class="nav-link <?= ($activeMenu ?? '') === 'copyright' ? 'active' : '' ?>" href="<?= url('/reviewer/copyright') ?>"><i class="bi bi-shield-lock"></i>Copyright Claims</a>
                <a class="nav-link <?= ($activeMenu ?? '') === 'monetization' ? 'active' : '' ?>" href="<?= url('/reviewer/monetization') ?>"><i class="bi bi-cash-coin"></i>Monetization</a>
                <div class="nav-header">Appeals</div>
                <a class="nav-link <?= ($activeMenu ?? '') === 'appeals' ? 'active' : '' ?>" href="<?= url('/reviewer/appeals') ?>"><i class="bi bi-arrow-return-left"></i>Appeals</a>
            </nav>
        </aside>
