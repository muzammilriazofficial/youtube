...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="mb-0">Reported Videos</h4>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    <?php if (!empty($reports ?? [])): ?>
                        ...
                        <tr>
                            <td><?= e($report['username'] ?? 'User') ?></td>
                            <td class="text-truncate" style="max-width:200px;"><?= e($report['title'] ?? 'Deleted video') ?></td>
                            ...
                            <td class="text-end">
                                ...
                                <button class="btn btn-sm btn-success" onclick="takeAction(<?= $report['reportable_id'] ?>, 'approve')">Approve</button>
                                <button class="btn btn-sm btn-danger" onclick="takeAction(<?= $report['reportable_id'] ?>, 'remove')">Remove</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
...
<div class="modal fade" id="actionModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="<?= url('/moderator/videos/action') ?>">
                <?= csrf_field() ?>
